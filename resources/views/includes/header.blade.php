           ...
           <div class="animation-preloader">
               ...
               <div class="wind-shapes ">
                   <div class="preload-img">
                       ...
                       <div class="shape-1">
                           <svg width="128" height="178" viewBox="0 0 128 278" fill="none" xmlns="http://www.w3.org/2000/svg">
                   ...
                   <div class="header-top-wrapper">
                       <ul class="contact-list">
                           <li>
                               ...
                               <a href="mailto:info@example.com" class="link">info@tnrepa.in</a>
                           </li>
                           <li>
                               <i class="fa-solid fa-phone-volume"></i>
                               <a href="tel:+91 99655 33318">+91 99655 33318 </a> <span class="pl-3">|</span> <a href="tel:+91 99653 33318">+91 99653 33318 </a>
                           </li>


                       </ul>
                       <!-- <div class="top-title">
                           <h5> Renewable Energy Producers Association </h5>
                       </div> -->
                       <div class="top-right">
    @guest
    <!-- Show New Member Request only if user is NOT logged in -->
    <div class="top-btn">
        <a href="{{ route('MemberReg') }}" style="color: white;">
            <i class="fa fa-user"></i> New Member Request
        </a>
    </div>
    @endguest
    ...
    <a href="{{route('showprofile') }}"><div class="user-info" style="color: white; font-weight: bold;">
           ...
           <div class="container">
               <div class="header-infos-wrap">
                   <div class="d-flex">
                       ...
                       <div class="top-title">
                           <h5 class="rise"> Renewable Energy Producers Association </h5>

                       </div>

                       <div class="search-label d-flex align-items-center">
                           <form role="search" method="get" action="">
                               <div class="input-container">
                                   <input type="search" class="search-input" value="" name="s" placeholder="Search entire website..." />
                                   <button type="submit" class="search-submit" name="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
                               </div>
                           </form>
                                               ...
                                               <ul>
                                                   ...
                                                   <li class="has-dropdown">
                                                       ...
                                                       <ul class="submenu">
                                                          <li><a href="{{ route('welcome') }}#about-us">About Us</a></li>
                                                           ...
                                                           <li><a href="{{ route('Why') }}">Objectives </a></li>
                                                           <li><a href="#">Governing Body
                                                                   <i class="fas fa-angle-down"></i>
                                                               </a>
                                                               <ul class="submenu">
                                                                   <li><a href="{{ route('team') }}">Office Bearers </a></li>
                                                                   <li><a href="{{ route('committee') }}">Executive Committee</a></li>
                                                   ...
                                                   <li>
                                                       ...
                                                       <ul class="submenu">
                                                           ...
                                                           <li><a href="{{route('oems')}}"> OEMs </a></li>
                                                           <li><a href="{{route('amc_service')}}"> AMC SERVICE PROVIDERS</a></li>
                                                           <li><a href="{{route('vendors')}}"> VENDORS </a></li>
                                                           <li><a href="{{route('otherservice')}}"> OTHER SERVICE PROVIDERS / RE CONSULTANTS </a></li>
                                                   ...
                                                   <li>
                                                       ...
                                                       <ul class="submenu">
                                                           ...
                                                           <li><a href="{{ route('advocate') }}"> Advocates </a></li>
                                                   ...
                                                   <li>
                                                       ...
                                                       <ul class="submenu">
                                                           ...
                                                           <li><a href="{{ route('welcome') }}#Forecasting">Forecasting V<span class="small-ltr">s.</span> Actuals </a></li>
                                                           <li><a href="{{ route('welcome') }}#tn-power-supply"> TN Power Supply Position </a></li>

                                                       </ul>

                                                   </li>
                                                   <li><a href="{{ route('repamart') }}">REPA MART</a></li>
                                                   <li>
                                                       ...
                                                       <ul class="submenu">
                                                           ...
                                                           <li><a href="{{ route('download') }}#circulars"> Circulars </a></li>
                                                           <li><a href="{{ route('download') }}#forms">Forms </a></li>
                                                           <li><a href="{{ route('download') }}#annual-reports"> Annual Reports </a></li>
                                                           <li><a href="{{ route('download') }}#comments"> Comments </a></li>
    ...
    @guest
    <!-- Show Member Login button only if the user is NOT logged in -->
    <a href="{{ route('MemberLogin') }}" class="theme-btn">
        <span>
            Member Login
