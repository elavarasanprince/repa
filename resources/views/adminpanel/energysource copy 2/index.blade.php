                ...
                <div class="col-sm-2 p-0">
                    <div class="overflow-hidden">
                        <button class="btn  mx-auto mt-3" type="button" data-bs-toggle="modal"
                                data-bs-target="#addDoctor"  style="background-color: #1B1F23; color: #ffffff; border: none;">Add Energy Soruces
                                </button>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="addDoctor" tabindex="-1" role="dialog" aria-labelledby="addDoctor" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content dark-sign-up">
            <!-- Modal Header -->
                <div class="modal-header">
                    <!-- Title on the left -->
                    <h3 class="modal-title" id="addDoctor">Forecast & Actuals Details</h3>
                ...
                <div class="modal-body social-profile text-start">
                    ...
                    <form action="{{ route('energysource.store') }}" method="POST">
    @csrf
