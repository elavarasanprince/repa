            ...
            <div class="marquee-inner to-left">
                <ul class="marqee-list d-flex">
                    <li class="marquee-item">
                        <span class="text-slider">TN Energy Status</span><span class="text-slider"><img src="assets/img/star.svg" alt="img"></span>
                        <span class="text-slider">TN Energy Status</span><span class="text-slider"><img src="assets/img/star.svg" alt="img"></span>
                        <span class="text-slider">TN Energy Status</span><span class="text-slider"><img src="assets/img/star.svg" alt="img"></span>
                        <span class="text-slider">TN Energy Status</span><span class="text-slider"><img src="assets/img/star.svg" alt="img"></span>
                        <span class="text-slider">TN Energy Status</span><span class="text-slider"><img src="assets/img/star.svg" alt="img"></span>
            ...
            <div class="achievement-wrapper style-2">
                ...
                <div class="counter-area">
                    <div class="counter-items wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="content">
                            <h2><span class="count">545</span>+</h2>
                            <p> Members
                            </p>
                        </div>
                    </div>
                    <div class="counter-items wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="content">
                            <h2><span class="count">4907 </span>+<span class="mw-text">MW</span> </h2>
                    ...
                    <div class="counter-items wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div class="content">
                            <h2><span class="count">2671</span>+<span class="mw-text">MW</span></h2>
                            <p> Wind Energy</p>
                        </div>
                    </div>
                    <div class="counter-items wow fadeInUp" data-wow-delay=".9s">
                        ...
                        <div class="content">
                            <h2><span class="count">2236</span>+<span class="mw-text">MW</span></h2>
                            <p>Solar Energy</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="news-updates">
                        ...
                        <div class="swiper latest-news">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="assets/pdf/REPA New Membership Application_18.12.2024.docx" target="_blank">
                                        <div class="news-item">
                                            <div class="news-date">
                                                <span class="mydate">2024-25</span>
                                            ...
                                            <div class="news-content news-content-1">
                                                ...
                                                <h6><img src="assets/img/word.png" class="pdf-label" alt="pdf"> Registration of REPA under Tamil Nadu Societies Registration Act 1975-Copy of Registration Certificate of REPA-Shared<span class="new-label">New</span></h6>
                                ...
                                <div class="swiper-slide">
                                    <a href="assets/pdf/Circular No. 02_List of Public Holidays for 2025_22.11.2024.pdf" target="_blank">
                                        <div class="news-item">
                                            <div class="news-date">
                                                <span class="mydate">2024-25</span>
                                            ...
                                            <div class="news-content news-content-1">
                                                ...
                                                <h6> <img src="assets/img/pdf.png" class="pdf-label" alt="pdf"> TN Public Holidays for the year 2025- Notified by the Government of Tamil Nadu-List of TN Public Holidays communicated.</h6>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="assets/pdf/holidays.pdf" target="_blank">
                                        <div class="news-item">
                                            <div class="news-date">
                                                <span class="mydate">2024-25</span>
                                            ...
                                            <div class="news-content news-content-1">
                                                ...
                                                <h6><img src="assets/img/pdf.png" class="pdf-label" alt="pdf"> Holidays-List of Holidays for the Secretariat of REPA for the Year 2025- Communicated.</h6>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="#">
                                        <div class="news-item">
                                            ...
                                            <h6> <img src="assets/img/pdf.png" class="pdf-label" alt="pdf"> CIRCULAR NO.90/2024-25 Notice for Verification-Alleged irregularities under the ABRY Scheme-EPFO HQ orders to keep the matter in abeyance-Regarding.</h6>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <a href="#">
                                        <div class="news-item">
                                            <div class="news-date">
                                                <span class="mydate">NOV 2024</span>
                        ...
                        <div class="swiper comment-news">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="news-item">
                                        <div class="news-img">
                                            <img src="assets/img/calendar.png" alt="repa-news">
                                        </div>
                                        <div class="news-content">
                                            <div class="date">
                                                <span>20/11/2024</span>
                                            </div>
                                            <h6>CIRCULAR NO.90/2024-25 Notice for Verification-Alleged irregularities under the ABRY Scheme-EPFO HQ orders to keep the matter in abeyance-Regarding.</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="news-item">
                                        ...
                                        <div class="news-content">
                                            ...
                                            <h6>CIRCULAR NO.88/2024-25 Formation of New Association from the House of TASMA for addressing the issues of the Renewable Energy Industry-Regarding.</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="news-item">
                                        ...
                                        <div class="news-content">
                                            ...
                                            <h6>CIRCULAR NO.87/2024-25 Consumer Price Index (CPI/DA)-For the Month of SEPTEMBER 2024-Communicated.</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row text-center mb-5">
                        <div class="col-md-5">
                            <!-- <h2 class="product-title text-primary">Product A</h2> -->
                            <b>Forecasted Energy (in MU) </b>
                        </div>
                        <div class="col-md-2">
                            <h2 id="Dateshow" class="Dateshow date-show"></h2>
                        </div>
                        <div class="col-md-5">
                            <!-- <h2 class="product-title text-success">Product B</h2> -->
                            <b>Actual Energy Evacuvated (in MU) </b>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-md-5">
                            <div class="skill">
                                ...
                                <div class="progress-bar">
                                    <div class="progress-fill blue" style="--percentage: 90%;"> <span class="skill-percentage">90 MU</span></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="skill">
                                ...
                                <div class="progress-bar">
                                    <div class="progress-fill" style="--percentage: 77%;">
                                        <span class="skill-percentage">80 MU</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-md-5">
                            <div class="skill">
                                ...
                                <div class="progress-bar">
                                    <div class="progress-fill blue" style="--percentage: 65%;"> <span class="skill-percentage">65 MU</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2 text-center">
                        ...
                        <div class="col-md-5">
                            <div class="skill">
                                ...
                                <div class="progress-bar">
                                    <div class="progress-fill" style="--percentage: 39%;"> <span class="skill-percentage">39 MU</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="tn-power-supply" class="tn-energy ptb-50 bg-cover" style="background-image: url('assets/img/service-bg-3.jpg');">
        <div class="container">
            <div class="section-title text-center mb-5">
                ...
                <div class="pt-5">
                    <h2 id="Dateshow" class="Dateshow date-show ">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
                    ...
                    <div class="live-items d-flex flex-row-reverse">
                        <div class="live-item">
                            <div class="tnlive-icon">
                                <img src="assets/img//icons/power.png" alt="">
                            </div>
                            <div class="live-content litblu">
                                <div class="data">
                                    <span>20.24 </span> <span class="mu-text">MU </span>
                                </div>
                                <h6>Thermal</h6>
                            </div>
                        </div>
                        <div class="live-item">
                            <div class="tnlive-icon">
                                <img src="assets/img//icons/dam.png" alt="">
                            </div>
                            <div class="live-content litpnk">
                                <div class="data">
                                    <span>30.76</span> <span class="mu-text">MU </span>
                                </div>
                                <h6>Hydro</h6>
                            </div>
                        </div>
                        <div class="live-item">
                            <div class="tnlive-icon">
                                <img src="assets/img//icons/gas.png" alt="">
                            </div>
                            <div class="live-content litorg">
                                <div class="data">
                                    <span>38.31</span> <span class="mu-text">MU </span>
                                </div>
                                <h6>Gas/Naptha</h6>
                            </div>
                        </div>
                        <div class="live-item">
                            <div class="tnlive-icon">
                                <img src="assets/img//icons/wind-turbine.png" alt="">
                            </div>
                            <div class="live-content litcrn">
                                <div class="data">
                                    <span>46.09</span> <span class="mu-text">MU </span>
                                </div>
                                <h6>Wind</h6>
                            </div>
                        </div>
                        <div class="live-item">
                            <div class="tnlive-icon">
                                <img src="assets/img//icons/solar-energy.png" alt="">
                            </div>
                            <div class="live-content litrd">
                                <div class="data">
                                    <span>68.12</span> <span class="mu-text">MU </span>
                                </div>
                                <h6>Solar</h6>
                            </div>
                        </div>
                        <div class="live-item">
                            <div class="tnlive-icon">
                                <img src="assets/img//icons/bio-gas.png" alt="">
                            </div>
                            <div class="live-content litgrn">
                                <div class="data">
                                    <span>90.45</span> <span class="mu-text">MU </span>
                                </div>
                                <h6>Bio/Co-Gen</h6>
                            </div>
                        </div>
                        <div class="live-item">
                            <div class="tnlive-icon">
                                <img src="assets/img//icons/renewable-energy.png" alt="">
                            </div>
                            <div class="live-content litylw">
                                <div class="data">
                                    <span>110.96</span> <span class="mu-text">MU </span>
                                </div>
                                <h6>Central Grid</h6>
                            </div>
                        </div>
                    ...
                    <div class="live-items d-flex">
                        <div class="live-item">
                            ...
                            <div class="live-content litcyen">
                                <div class="data">
                                    <span>275.04</span> <span class="mu-text"> MU </span>
                                </div>
                                <h6>Availability</h6>
                            </div>
                        </div>
                        ...
                        <div class="live-item">
                            ...
                            <div class="live-content litwhite">
                                <div class="data">
                                    <span>218.54</span> <span class="mu-text"> MU </span>
                                </div>
                                <h6>Demand Met</h6>
                            </div>
                        </div>
    ...
    <section class="news-section fix ptb-50">
        <div class="container">
            <div class="section-title-area">
                ...
                <a href="events.php" class="theme-btn wow fadeInUp" data-wow-delay=".5s">
                    All Events
                    <i class="fa-solid fa-arrow-right-long"></i>
                </a>
            </div>
            <div class="swiper events-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="news-card-items">
                            <div class="news-image">
                                <img src="assets/img/events/event-2.jpg" alt="news-img">
                                <div class="post-date">
                                    <h3>
                                        29 <br>
                                        <span>Sept</span>
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="#">Registration of Members </a>
                                </h3>
                    ...
                    <div class="swiper-slide">
                        <div class="news-card-items">
                            <div class="news-image">
                                <img src="assets/img/events/event-6.jpg" alt="news-img">
                                <div class="post-date">
                                    <h3>
                                        29<br>
                                        <span>Sept</span>
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="#">Introductory speech on REPA by <br> Dr. K. VENKATACHALAM, <br> CEO, REPA </a>
                                </h3>
                                <a href="#" class="theme-btn-2 mt-3">
                                    read More
                                    <i class="fa-solid fa-arrow-right-long"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="news-card-items">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="#">Grand unveiling of REPA LOGO by Mr. P.V. CHANDRAN, <br> Vice President, REPA </a>
                                </h3>
                                <a href="#" class="theme-btn-2 mt-3">
                                    read More
                                    <i class="fa-solid fa-arrow-right-long"></i>
...
@include('includes.script')
    ...
    <script>
        ...
        var options = {
            series: [{
                name: "",
                data: [20.24, 30.76, 38.31, 46.09, 68.12, 90.45, 110.96],
            }],
            ...
            dataLabels: {
                ...
                formatter: function(val, opt) {
                    // Include category and value with "MU" suffix
                    const category = opt.w.globals.labels[opt.dataPointIndex]; // Get the corresponding category
                    return `${category}: ${val.toFixed(2)} MU`; // Combine category and value
                },
                dropShadow: {
                    enabled: true,
                },
            ...
            xaxis: {
                ...
                labels: {
                    style: {
                        ...
                        colors: '#000', // Optional: specify color for labels
                    }
                }
            },
            tooltip: {
                y: {
                    formatter: function(val) {
                        return `${val.toFixed(2)} MU`; // Add "MU" after the value in the tooltip
                    }
                }
            },
            legend: {
        ...
        var piechart = {
            ...
            dataLabels: {
                ...
                formatter: function(val, opts) {
                    // Custom formatter to show percentage and value
        ...
        const apiUrl = "https://windbuilt.in/api/api.lgepl_forecast.php?key=bGdlcGx3aW5kcG93ZXJmb3JlY2FzdA==";
        ...
        function getFormattedDate() {
            ...
            const options = {
                month: 'short'
            }; // Format the month as a short name (e.g., Dec)
            const month = new Intl.DateTimeFormat('en-US', options).format(date); // Format month
            const day = String(date.getDate()).padStart(2, '0'); // Get the day and pad with 0 if necessary
            const year = date.getFullYear(); // Get the year

            return `${month}-${day}-${year}`; // Combine parts in desired format
        }
